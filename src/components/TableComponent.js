...
import {countryData} from '../util/Constants'
...
export default function ColumnGroupingTable() {
    ...
    const countryNames = useSelector((CountiesStore)=>CountiesStore.Countries.countryNames)
    console.log(countryNames);

// Fetching api with an error handling method
